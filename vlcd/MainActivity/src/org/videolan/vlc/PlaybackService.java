...
public class PlaybackService extends Service implements IVLCVout.Callback {
    ...
    public void onCreate() {
        ...
        mRemoteControlClientReceiverComponent = new ComponentName(Config.APPLICATION_ID,
    ...
    private void showNotification() {
        ...
        try {
            ...
            if (AndroidUtil.isJellyBeanOrLater()) {
                ...
                RemoteViews view = new RemoteViews(Config.APPLICATION_ID, R.layout.notification);
                ...
                RemoteViews view_expanded = new RemoteViews(Config.APPLICATION_ID, R.layout.notification_expanded);
