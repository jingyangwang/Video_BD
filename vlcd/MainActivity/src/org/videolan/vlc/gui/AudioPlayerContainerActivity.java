...
//	public class AudioPlayerContainerActivity extends ActionBarActivity implements PlaybackService.Client.Callback  {
    ...
    public void showTipViewIfNeeded(final int layoutId, final String settingKey) {
        if (!mSettings.getBoolean(settingKey, false) && !Config.tv) {
